...
namespace Diode_Dominion.DiodeDominion.Entities.Animals
{
    ...
    public class Giraffe : Animal
    {
        ...
        public Giraffe(float x, float y, MapTile[,] tiles) : base(AnimalType.GIRAFFE, x, y, tiles)
        {
        ...
        /// <param name="tiles"></param>
        public Giraffe(float x, float y, bool value, Random random, MapTile[,] tiles) : base(AnimalType.GIRAFFE, x, y, tiles)
        {
            EntitySprite.Origin = new Vector2(x, y);
            MovementSpeed = 0.2f;

...
namespace Diode_Dominion.DiodeDominion.Entities.Animals
{
    ...
    public class Ostrich : Animal
    {
        ...
        /// </summary>
        private const int LocationBuffer = 50;
        ...
        public Ostrich(float x, float y, MapTile[,] tiles) : base(AnimalType.OSTRICH, x, y, tiles)
        {
        ...
        /// <param name="tiles"></param>
        public Ostrich(float x, float y, bool value, Random random, MapTile[,] tiles) : base(AnimalType.OSTRICH, x, y, tiles)
        {
            EntitySprite.Origin = new Vector2(x, y);
            MovementSpeed = 0.3f;

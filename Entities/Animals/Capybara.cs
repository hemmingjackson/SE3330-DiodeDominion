...
namespace Diode_Dominion.DiodeDominion.Entities.Animals
{
    ...
    public class Capybara : Animal
    {
        ...
        /// </summary>
        private const int LocationBuffer = 55;
        ...
        public Capybara(float x, float y, MapTile[,] tiles) : base(AnimalType.CAPYBARA, x, y, tiles)
        {
        ...
        /// <param name="tiles"></param>
        public Capybara(float x, float y, bool value, Random random, MapTile[,] tiles) : base(AnimalType.CAPYBARA, x, y, tiles)
        {
            EntitySprite.Origin = new Vector2(x, y);
            MovementSpeed = 0.15f;
